...
var _user$project$Main$getGifs = function (characterName) {
	var url = A2(
		_elm_lang$core$Basics_ops['++'],
		'https://api.giphy.com/v1/gifs/search?api_key=Pwh6oykW1llZjlVW5hOcjNrytlOiFJDI&q=',
		A2(
			_elm_lang$core$Basics_ops['++'],
			_elm_lang$core$Basics$toString(characterName),
			'&limit=8&offset=0&rating=R&lang=en'));
