...
var _user$project$Main$UpdateGifUrls = {ctor: 'UpdateGifUrls'};
var _user$project$Main$SelectCharacter = function (a) {
	return {ctor: 'SelectCharacter', _0: a};
};
var _user$project$Main$createCharacterButton = F2(
	function (characterName, characterUrl) {
		return A2(
			...
			},
			{
				...
				_0: A2(
					...
					{
						ctor: '::',
						_0: _elm_lang$html$Html_Attributes$src(characterUrl),
						_1: {
							ctor: '::',
							_0: _elm_lang$html$Html_Attributes$alt(
								_elm_lang$core$Basics$toString(characterName)),
							_1: {ctor: '[]'}
						}
					},
					{ctor: '[]'}),
...
if (typeof _user$project$Main$main !== 'undefined') {
    _user$project$Main$main(Elm['Main'], 'Main', {"types":{"unions":{"Main.Character":{"args":[],"tags":{"Totoro":[],"NoFace":[],"Chibi":[]}},"Main.Msg":{"args":[],"tags":{"SelectCharacter":["Main.Character"],"UpdateGifUrls":[]}}},"aliases":{},"message":"Main.Msg"},"versions":{"elm":"0.18.0"}});
}
